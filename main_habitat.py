...
import time
import math
from dataloader.habitat_dataset import HabitatDataset
from models import *
...
parser.add_argument('--splitpath',
                    help='path to folder containing habitat splits')
...
TrainImgLoader = torch.utils.data.DataLoader(HabitatDataset(
    os.path.join(args.splitpath, 'habitat_train_depth.txt'), True), 
    batch_size= 12, shuffle= True, num_workers= 8, drop_last=False)

TestImgLoader = torch.utils.data.DataLoader(HabitatDataset(
    os.path.join(args.splitpath, 'habitat_val_depth.txt'), False), 
